...
if (!function_exists('masonic_posted_on')) :
   ...
   function masonic_posted_on() {
      ...
      echo '<div class="entry-author vcard author fa fa-user"><a class="url fn n" href="' . esc_url(get_author_posts_url(get_the_author_meta('ID'))) . '">' . esc_html(get_the_author()) . '</a><span class="dp-share-icon"><a rel="nofollow" class="dp-facebook" href="' . esc_url( get_permalink()) . '?share=facebook&amp;nb=1" target="_blank" title="Click to share on Facebook"></a><a rel="nofollow" class="dp-twitter" href="' . esc_url( get_permalink()) . '?share=twitter&amp;nb=1" target="_blank" title="Click to share on Twitter"></a><a rel="nofollow" class="dp-linkedin" href="' . esc_url( get_permalink()) . '?share=linkedin&amp;nb=1" target="_blank" title="Click to share on LinkedIn"></a><a rel="nofollow" class="dp-pinterest" href="' . esc_url( get_permalink()) .'?share=pinterest&amp;nb=1" target="_blank" title="Click to share on Pinterest"></a></span></div>';
